...
2.  Zeitstempel (im Format "YYYY-MM-DD HH:MM:SS.SSS" - sqllite - DATETIME) der erfassten Werte und die Werte in einer Datenbank (sqlite) speichern und dann in einer .csv Tabelle **messung_3.csv** 
    exportieren.
