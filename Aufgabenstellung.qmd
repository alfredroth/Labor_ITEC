...
2.   Das messen des Abstands vom Sensor zur Fläche wird mit einem Tastendruck auf Enter ausgelöst. Dieser Wert wird als gelesener 
     Abstandswert (in Zentimeter) in einer Datenbank (sqlite) und dann von dort in einer 
...
1. C Datei mit einem Minimalbeispiel zum Auslesen der Werte aus der Blackbox:
...
## Ablauf im Visual Studio Code

![C Datei](Aufgabenstellung_Bilder/b10_Datei.png.jpg)

![Debug & Run](Aufgabenstellung_Bilder/b11_DateiDebugRun.png)

![Compiller](Aufgabenstellung_Bilder/b12_CompilerWaehlen.png)

![Restart](Aufgabenstellung_Bilder/b13_Restart.png)

:::

2. Debug&Run durchführen
3. 
